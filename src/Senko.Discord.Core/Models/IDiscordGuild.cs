...
namespace Senko.Discord
{
    public interface IDiscordGuild : ISnowflake
    {
        ...
        ValueTask AddBanAsync(IDiscordGuildUser user, int pruneDays = 1, string reason = null);

        /// <summary>
        /// Creates a new role. Requires <see cref="GuildPermission.ManageRoles"/> permission.
        /// </summary>
        /// <param name="roleArgs">Role properties</param>
        ValueTask<IDiscordRole> CreateRoleAsync(CreateRoleArgs roleArgs);

        /// <summary>
        /// Gets the system channel.
        /// </summary>
        ValueTask<IDiscordChannel> GetDefaultChannelAsync();
        ...
        /// </summary>
        ValueTask<IDiscordGuildUser> GetOwnerAsync();
        ...
        ValueTask<IDiscordGuildChannel> GetChannelAsync(ulong id);

        /// <summary>
        /// Returns all channels in a guild.
        /// </summary>
        ValueTask<IEnumerable<IDiscordGuildChannel>> GetChannelsAsync();
        ...
        ValueTask<IDiscordRole> GetRoleAsync(ulong id);

        /// <summary>
        /// Returns all roles in a guild.
        /// </summary>
        ValueTask<IEnumerable<IDiscordRole>> GetRolesAsync();

        /// <summary>
        /// Returns all members in a guild.
        /// </summary>
        ValueTask<IEnumerable<IDiscordGuildUser>> GetMembersAsync();
        ...
        /// <returns></returns>
        ValueTask<IDiscordGuildUser> GetMemberAsync(ulong id);
        ...
        ValueTask<int> GetPruneCountAsync(int days);
